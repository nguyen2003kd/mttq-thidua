...
import { ArrowLeft, Download, FileText, History, MessageSquareWarning, Send } from 'lucide-react';
import { Link, useNavigate, useParams } from 'react-router-dom';
import { useQuery, useQueryClient } from '@tanstack/react-query';
import { toast } from 'sonner';
import { Button, ConfirmDialog, EmptyState, ListDialog, PageHeader, PageLoading, RejectDialog, TableColumnVisibility, TruncatedText } from '@/components/core';
