...
import { Eye, History, MessageSquare, MessageSquareWarning, Search, Send } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';
import type { ColumnDef } from '@tanstack/react-table';
import { ConfirmDialog, DataTable, EmptyState, PageHeader, PageLoading, RejectDialog, ScoreStateBadge } from '@/components/core';
...
export default function CouncilApprovalPage() {
  ...
  const approveSelected = () => processSelectedSubmissions(
    (submission) => specialistApi.approveSubmission(submission.id, 'Hội đồng thi đua đã xem xét và duyệt hồ sơ.'),
